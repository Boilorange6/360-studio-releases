...
0.2.13은 관람 스타일 선택창을 썸네일 없는 작은 선택 버튼과 원본 비교 버튼으로 줄였습니다. 같은 공간의 스타일 전환, 시선·확대 유지, 스타일별 핫스팟을 지원합니다. PC 편집기에서 스타일을 추가한 ZIP을 가져와 사용하세요. 갤럭시탭 실기기 검증은 남아 있는 시험판입니다.

[0.2.13 설치 파일 다운로드](https://github.com/Boilorange6/360-studio-releases/releases/download/v0.2.13/360-studio-viewer-debug.apk)
