...
[0.2.2 설치 파일 다운로드](https://github.com/Boilorange6/360-studio-releases/releases/download/v0.2.2/360-studio-viewer-debug.apk)

- 0.2.0 사용자: 앱의 업데이트 확인 → 다운로드 → 설치로 업데이트합니다.
- 0.2.1에서 실행 직후 종료되는 경우: 위 0.2.2 APK를 직접 다운로드하여 기존 앱 위에 덮어 설치하세요. 앱 삭제나 데이터 초기화는 하지 마세요.
