...
0.2.17은 장면 선택 버튼을 오른쪽 아래로 옮기고, 번호·이름 중심의 목록과 현재 장면 표시를 제공합니다. 태블릿·스마트폰에 맞춰 목록과 설정·설명 창의 여백을 다듬었습니다.
...
[0.2.17 설치 파일 다운로드](https://github.com/Boilorange6/360-studio-releases/releases/download/v0.2.17/360-studio-viewer-debug.apk)
