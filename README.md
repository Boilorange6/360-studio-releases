...
0.2.14는 첫 사용 안내, 이전 공간·방문 진행·자동 안내, 고대비, 콘텐츠 표지와 전시 PIN을 추가했습니다. 설정 → 투어 관리에서 휴지통 복구, 수정본 ZIP 교체와 현장 파일 점검을 제공합니다. 같은 공간의 스타일 전환, 시선·확대 유지, 스타일별 핫스팟을 지원합니다. PC 편집기에서 스타일을 추가한 ZIP을 가져와 사용하세요. 갤럭시탭 실기기 검증은 남아 있는 시험판입니다.

[0.2.14 설치 파일 다운로드](https://github.com/Boilorange6/360-studio-releases/releases/download/v0.2.14/360-studio-viewer-debug.apk)
